...
const ABBR_REPLACEMENTS = [
  ...
  [/\bpax\b/gi, "pasajeros"],
  [/\bsta\b/gi, "hora programada de llegada"],
  [/\bstd\b/gi, "hora programada de salida"],
  [/\bpic\b/gi, "piloto al mando"],
  [/\bsic\b/gi, "copiloto"],
  [/\bfbo\b/gi, "operador fijo en tierra"],
  [/\bw&b\b/gi, "peso y balance"],
  [/\bfir\b/gi, "región de información de vuelo"],
  [/\btfr\b/gi, "restricción temporal de vuelo"],
  [/\bifr\b/gi, "reglas de vuelo por instrumentos"],
  [/\bvfr\b/gi, "reglas de vuelo visual"],
  [/\bron\b/gi, "pernocta de aeronave"],
  [/\boooi\b/gi, "tiempos fuera-de-puerta y dentro-de-puerta"],
  [/\bfob\b/gi, "combustible a bordo"],
  [/\bt\/o\b/gi, "despegue"],
  [/\bldg\b/gi, "aterrizaje"],
  [/\bgnd\b/gi, "tierra"],
  [/\batc\b/gi, "control de tránsito aéreo"],
  [/\brepo\b/gi, "reposicionamiento"],
  [/\bferry\b/gi, "vuelo ferry"],
  [/\bquick turn\b/gi, "escala rápida"],
  [/\bhandler\b/gi, "agente de asistencia en tierra"],
  [/\bcrew\b/gi, "tripulación"],
  [/\bdep\b/gi, "salida"],
  [/\barr\b/gi, "llegada"],
];
